...
class CpfCnpjRule implements Rule
{
    ...
    {
        //Retirando apenas os numeros da String
        $numberValue = preg_replace('/[^0-9]/', '', $value);
        if(strlen($numberValue) == 11){
            //é um CPF
            return $this->validarCpf($numberValue);
        }else{
            //é um CNPJ
            return $this->validarCnpj($numberValue);
        }
    }
